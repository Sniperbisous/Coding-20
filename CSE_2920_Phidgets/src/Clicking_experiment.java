...
public class Clicking_experiment {
    ...
    public static void main(String[] args) throws Exception{
        ...
        boolean red_button_state, green_button_state, last_red_button_state, last_green_button_state;
        last_red_button_state = false;
        int clicks = 0;
        ...
        while(true){
            ...
            if (red_button_state != last_red_button_state || red_button_state != false )
            {
            	clicks += 1;
            	last_red_button_state = red_button_state;
