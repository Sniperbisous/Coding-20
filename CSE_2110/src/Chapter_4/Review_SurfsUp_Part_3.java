...
Program: Review_SurfsUp_Part_3.java          Last Date of this Revision: March 3, 2022

Purpose: To display "Great day for surfing!" when the input wave high is higher than 6, "Go body boarding!" when it is less than 6 and higher than 3 and "Whoa! What kind of surf is that?" 
...
public class Review_SurfsUp_Part_3
{
	...
	public static void main(String[] args) 
	{
		...
		//If the wave height is less than 3 "Go for a swim." 
		else if(wave_h < 3)
			{
